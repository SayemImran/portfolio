...
export default function Hero() {
  ...
  return (
    <section id="home" className="min-h-[90vh] flex flex-col lg:flex-row items-center px-6 md:px-14 pt-[120px] lg:pt-0 pb-12 gap-12 lg:gap-20 relative overflow-hidden">
      {/* Background Decor */}
