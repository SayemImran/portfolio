    ...
    <>
      <nav className={`fixed top-0 left-0 right-0 z-[100] h-[64px] flex items-center justify-between px-6 md:px-14 backdrop-blur-2xl border-b border-white/5 transition-all duration-500 ${
        ...
        <div className="flex items-center gap-4">
          <Link href="#contact" className="hidden lg:flex px-5 py-2 rounded-lg bg-white/5 border border-white/10 text-white font-medium text-[0.75rem] no-underline hover:bg-white/10 transition-all active:scale-95">
            Hire Me
          </Link>
          ...
          <button 
            ...
            className="flex md:hidden w-8 h-8 items-center justify-center rounded-lg bg-white/5 border border-white/10 text-white/70 hover:text-white transition-all"
          >
